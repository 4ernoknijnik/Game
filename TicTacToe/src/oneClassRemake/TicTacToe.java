...
public class TicTacToe extends Applet implements ActionListener {
	...
	/**
	 * Этот метод вызывается после каждого хода, чтобы узнать, есть ли
	 * победитель. Он проверяет каждый ряд, колонку и диагональ, чтобы найти три
	 * клетки с одинаковыми надписями (не пустыми)
	 * 
	...
	/**
	 * Этот метод проверяет каждый ряд, колонку и диагональ чтобы узнать, есть
	 * ли в ней две клетки с одинаковыми надписями и пустой клеткой.
	 * 
	 * @param передается
	 *            X – для пользователя и O – для компа
	 ...
	 * 
	 * @param первая
	 *            , вторая и третья клетки для выделения
	 */
